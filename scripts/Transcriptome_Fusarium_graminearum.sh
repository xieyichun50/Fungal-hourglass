...
hisat2 -x Fusarium_graminearum.genomic.fa -U $id2.fastp.fastq -S $id2.sam --phred33 --dta-cufflinks --novel-splicesite-outfile $id2.splicesite.txt  -p 38
...
####Expression level
gff=Fusarium_graminearum.genomic.gff
dir=DEG
cat samples_n_reads_decribed.txt | while read id1 id2 SRR;
do  
